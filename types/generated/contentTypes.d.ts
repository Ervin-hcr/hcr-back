...
export interface ApiAccueilAccueil extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    imageAccueil: Schema.Attribute.Media<
...
export interface ApiPhotosTravauxPhotosTravaux
  extends Struct.CollectionTypeSchema {
  collectionName: 'photos_travauxes';
  info: {
    displayName: 'photosTravaux';
    pluralName: 'photos-travauxes';
    singularName: 'photos-travaux';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::photos-travaux.photos-travaux'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiPresentationServicePresentationService
  extends Struct.CollectionTypeSchema {
  collectionName: 'presentation_services';
  info: {
    displayName: 'presentationService';
    pluralName: 'presentation-services';
    singularName: 'presentation-service';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::presentation-service.presentation-service'
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    titre: Schema.Attribute.String;
...
export interface ApiPresentationPresentation
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    presentationEntreprise: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    titre: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
